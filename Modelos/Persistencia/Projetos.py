...
class Projetos:
    ...
    @classmethod
    def listar_meus(cls, idPessoa):
        cls.abrir()
        for obj in cls.objetos:
            if obj.get_idCriador() == idPessoa:
                return obj
        return None
    ...
    def atualizar(cls, obj):
        ...
        if found:
            ...
            raise ValueError(f"Projeto com ID {obj.get_id()} não encontrado para atualização.")
    ...
    def excluir(cls, obj):
        ...
        if len(cls.objetos) < original_len:
            ...
            raise ValueError(f"Projeto com ID {obj.get_id()} não encontrado para exclusão.")
