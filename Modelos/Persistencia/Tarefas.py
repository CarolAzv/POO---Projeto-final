...
class Tarefas:
    ...
    @classmethod
    def listar_minhasUsuario(cls, idUsuario):
        cls.abrir()
        for obj in cls.objetos:
            if obj.get_idUsuario() == idUsuario:
                return obj
        return None

    @classmethod
    def listar_minhasProjeto(cls, idProjeto):
        cls.abrir()
        for obj in cls.objetos:
    ...
    def atualizar(cls, obj):
        ...
        if found:
            ...
            raise ValueError(f"Tarefa com ID {obj.get_id()} não encontrado para atualização.")
    ...
    def excluir(cls, obj):
        ...
        if len(cls.objetos) < original_len:
            ...
            raise ValueError(f"Tarefa com ID {obj.get_id()} não encontrado para exclusão.")
